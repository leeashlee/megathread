    ...
    <div class="my-6 w-full overflow-y-auto">
        <Table>
            ...
            <TableBody>
                ...
                <TableRow>
                    <TableCell>PSP Redump .iso (Part 1)</TableCell>
                    <TableCell></TableCell>
                    <TableCell
                        ><a
                            class="text-primary font-medium underline underline-offset-4 md:text-base hover:bg-primary hover:text-primary-foreground"
                ...
                <TableRow>
                    <TableCell>PSP Redump .iso (Part 2)</TableCell>
                    <TableCell></TableCell>
                    <TableCell
                        ><a
                            class="text-primary font-medium underline underline-offset-4 md:text-base hover:bg-primary hover:text-primary-foreground"
                ...
                <TableRow>
                    <TableCell>PSP Redump .iso (Part 3)</TableCell>
                    <TableCell></TableCell>
                    <TableCell
                        ><a
                            class="text-primary font-medium underline underline-offset-4 md:text-base hover:bg-primary hover:text-primary-foreground"
                ...
                <TableRow>
                    <TableCell>PSP Redump .iso (Part 4)</TableCell>
                    <TableCell></TableCell>
                    <TableCell
                        ><a
                            class="text-primary font-medium underline underline-offset-4 md:text-base hover:bg-primary hover:text-primary-foreground"
                ...
                <TableRow>
                    <TableCell>PSP Redump .chd (Part 1)</TableCell>
                    <TableCell
                        ><a
                            class="text-primary font-medium underline underline-offset-4 md:text-base hover:bg-primary hover:text-primary-foreground"
                ...
                <TableRow>
                    <TableCell>PSP Redump .chd (Part 2)</TableCell>
                    <TableCell
                        ><a
                            class="text-primary font-medium underline underline-offset-4 md:text-base hover:bg-primary hover:text-primary-foreground"
                ...
                <TableRow>
                    <TableCell>PSP DLC (Alvro Files)</TableCell>
                    <TableCell></TableCell>
                    <TableCell
                        ><a
                            class="text-primary font-medium underline underline-offset-4 md:text-base hover:bg-primary hover:text-primary-foreground"
