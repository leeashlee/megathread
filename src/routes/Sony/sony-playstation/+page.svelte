...
<div class="mx-8 mb-8 mt-8 space-y-4 bg-background">
    ...
    <div class="my-6 w-full overflow-y-auto">
        <Table>
            ...
            <TableBody>
                <TableRow>
                    <TableCell>Sony - PlayStation</TableCell>
                    <TableCell
                        ><a
                ...
                <TableRow>
                    <TableCell
                        >Sony PlayStation (Part 1: #-D) - Redump.org</TableCell
                    >
                    <TableCell></TableCell>
                    <TableCell
                        ><a
                ...
                <TableRow>
                    <TableCell
                        >Sony PlayStation (Part 2: E-I) - Redump.org</TableCell
                    >
                    <TableCell></TableCell>
                    <TableCell
                        ><a
                ...
                <TableRow>
                    <TableCell
                        >Sony PlayStation (Part 3: J-N) - Redump.org</TableCell
                    >
                    <TableCell></TableCell>
                    <TableCell
                        ><a
                ...
                <TableRow>
                    <TableCell
                        >Sony PlayStation (Part 4: O-S) - Redump.org</TableCell
                    >
                    <TableCell></TableCell>
                    <TableCell
                        ><a
                ...
                <TableRow>
                    <TableCell
                        >Sony PlayStation (Part 5: T-Z) - Redump.org</TableCell
                    >
                    <TableCell></TableCell>
                    <TableCell
                        ><a
                ...
                <TableRow>
                    <TableCell>PS1 Redump .chd USA</TableCell>
                    <TableCell
                        ><a
                            class="text-primary font-medium underline underline-offset-4 md:text-base hover:bg-primary hover:text-primary-foreground"
                ...
                <TableRow>
                    <TableCell>PS1 Redump .chd EUR</TableCell>
                    <TableCell
                        ><a
                            class="text-primary font-medium underline underline-offset-4 md:text-base hover:bg-primary hover:text-primary-foreground"
                ...
                <TableRow>
                    <TableCell>PS1 Redump .chd JPN Part 1</TableCell>
                    <TableCell
                        ><a
                            class="text-primary font-medium underline underline-offset-4 md:text-base hover:bg-primary hover:text-primary-foreground"
                ...
                <TableRow>
                    <TableCell>PS1 Redump .chd JPN Part 2</TableCell>
                    <TableCell
                        ><a
                            class="text-primary font-medium underline underline-offset-4 md:text-base hover:bg-primary hover:text-primary-foreground"
                ...
                <TableRow>
                    <TableCell>PS1 Redump .chd Misc</TableCell>
                    <TableCell
                        ><a
                            class="text-primary font-medium underline underline-offset-4 md:text-base hover:bg-primary hover:text-primary-foreground"
